...
<title>Indexes: All Springs</title>
</head>
...
<td colspan="<? print $NumberOfColumns ?>"><? print $count ?> springs are listed on <span class="mySiteName">showcaves.com</span> on <? print date("d-M-Y H:i:s") ?></td>
</tfoot>
...
<ul>
<li>The <b>country codes</b> are added to each spring. Those codes are the two letter country codes, used for first level domains, as defined in ISO 3166.</li>
