...
<?php
            ...
            function createCountryCell($countrycode, $country, $chapter, $countries)
            {
                ...
                if ($countrycode == 'XX') {
                    $countrycell = "<a data-ajax=\"false\" href=\"$filebase/other/region/$chapter.html\" id=\"$chapter\">$country</a>";
                    $cellatts = "";
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../german/explain/Index/Statistics.html"><img alt="Deutsch - German" src="../../../graphics/language/de.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
