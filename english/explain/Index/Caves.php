...
<head>
    ...
    <link rel="alternate" hreflang="de" href="../../../german/explain/Index/Caves.html"/>
    <!-- begin responsive -->
    ...
    <meta property="og:title" content="Indexes: All Caves"/>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?php
            printAllByCategory($pdo, 'caves', false);
            ?>
        </ul>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../german/explain/Index/Caves.php"><img alt="Deutsch - German" src="../../../graphics/language/de.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
