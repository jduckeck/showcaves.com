...
<h1 align="center">All Show Caves</h1>
<h2 align="center"></h2>
...
<td colspan="<? print $NumberOfColumns ?>"><? print $count ?> show caves are listed on <span class="mySiteName">showcaves.com</span> on <? print date("d-M-Y H:i:s") ?></td>
</tfoot>
...
<ul>
<li>The <b>country codes</b> are added to each cave. Those codes are the two letter country codes, used for first level domains, as defined in ISO 3166.</li>
