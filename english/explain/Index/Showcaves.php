...
<head>
    ...
    <link rel="alternate" hreflang="de" href="../../../german/explain/Index/Showcaves.html"/>
    <!-- begin responsive -->
    ...
    <meta property="og:title" content="Indexes: All Show Caves"/>
    ...
    <title>Indexes: All Show Caves</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">All Show Caves</h1>
        <h2 class="center"><?php print $count ?> show caves are listed on <span class="mySiteName">showcaves.com</span> on <?php print strtoupper(date("d-M-Y H:i")) ?></h2>
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?php
            printAllByCategory($pdo, 'showcaves', false);
            ?>
        </ul>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../german/explain/Index/Showcaves.php"><img alt="Deutsch - German" src="../../../graphics/language/de.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
