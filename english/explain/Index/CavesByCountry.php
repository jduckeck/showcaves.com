...
<head>
    ...
    <link rel="alternate" hreflang="de" href="../../../german/explain/Index/CavesByCountry.html"/>
    <!-- begin responsive -->
...
?>
    ...
    <meta property="og:title" content="Indexes: All Caves By Country"/>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">All Caves By Country</h1>
        <h2 class="center"><?php print $count ?> caves are listed on <span class="mySiteName">showcaves.com</span> on <?php print strtoupper(date("d-M-Y H:i")) ?></h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../german/explain/Index/CavesByCountry.php"><img alt="Deutsch - German" src="../../../graphics/language/de.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
