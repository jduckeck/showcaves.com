...
<head>
    ...
    <meta property="og:title" content="Indexes: All Subterranea By Country"/>
    ...
    <title>Indexes: All Subterranea By Country</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h2 class="center"><? print $count ?> subterranea are listed on <span class="mySiteName">showcaves.com</span> on <?php print strtoupper(date("d-M-Y H:i")) ?></h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../german/explain/Index/SubterraneaByCountry.php"><img alt="Deutsch - German" src="../../../graphics/language/de.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
