...
if ($conn) {
    ...
    if ( isset($SearchTerm) ) {
        $sql = "SELECT * FROM Terminology WHERE German LIKE '$SearchTerm'";
...
<TITLE>Terminology: German-English Dictionary</TITLE>
</HEAD>
...
<H1 ALIGN=CENTER>German-English Dictionary</H1>
<H2 ALIGN=CENTER></H2>
...
<P>
<TABLE>
<TR><TH>Id</TH><TH>English</TH><TH>German</TH><TH>Spanish</TH><TH>French</TH><TH>Hungarian</TH><TH>Italian</TH><TH>Portuguese</TH><TH>Romanian</TH></TR>
<TR><TD><? $row->Id ?></TD><TD><? $row->English ?></TD><TD><? $row->German ?></TD><TD><? $row->Spanish ?></TD><TD><? $row->French ?></TD><TD><? $row->Hungarian ?></TD><TD><? $row->Italian ?></TD><TD><? $row->Portuguese ?></TD><TD><? $row->Romanian ?></TD></TR>
</TABLE>
</P>
