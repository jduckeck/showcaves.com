...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/CavesByCountry.html"/>
    <!-- begin responsive -->
...
?>
    ...
    <title>Alphabethisches Register: Alle unausgebauten Höhlen nach Ländern gruppiert</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">Alle unausgebauten Höhlen nach Ländern gruppiert</h1>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/CavesByCountry.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
