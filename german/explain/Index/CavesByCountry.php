...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h2 class="center"><? print $count ?> unausgebaute Höhlen werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
