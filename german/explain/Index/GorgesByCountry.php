...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <?
        $sql = "SELECT name, filename, countrycode, country, chapter FROM sights WHERE visible='yes' AND category='gorges' ORDER BY country, sortby";
        $Category = "Gorge";
        $filebase = "../../..";
        $oldCountry = '';
        $entries = 0;
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/GorgesByCountry.php"><img alt="English" src="../../../graphics/flags/gb-small.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
