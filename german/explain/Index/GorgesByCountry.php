...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/GorgesByCountry.html"/>
    <!-- begin responsive -->
...
$count = countSights($pdo, " AND category='gorges'");
?>

    <meta property="og:locale" content="de_DE"/>
    <meta property="og:title" content="Alphabethisches Register: All Schluchten nach Ländern gruppiert"/>
    ...
    <title>Alphabethisches Register: All Schluchten nach Ländern gruppiert</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">Alle Schluchten nach Ländern gruppiert</h1>
        <h2 class="center"><?php print $count ?> Schluchten werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/GorgesByCountry.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
