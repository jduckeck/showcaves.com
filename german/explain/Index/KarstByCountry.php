...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h2 class="center"><? print $count ?> Karsterscheinungen werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/KarstByCountry.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
