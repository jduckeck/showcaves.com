...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 align="center">Alle unausgebauten Höhlen</h1>
        <h2 align="center"><? print $count ?> unausgebauten Höhlen werden auf <span class="mySiteName">showcaves.com</span> am <? print date("d-M-Y H:i:s") ?> beschrieben</h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/Caves.html"><img alt="English" src="../../../graphics/flags/gb-small.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
