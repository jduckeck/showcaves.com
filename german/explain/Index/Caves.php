...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/Caves.html"/>
    <!-- begin responsive -->
    ...
    <meta property="og:title" content="Alphabethisches Register: Alle unausgebauten Höhlen"/>
    ...
    <title>Alphabethisches Register: Alle unausgebauten Höhlen</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h2 class="center"><?php print $count ?> unausgebaute Höhlen werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?php
            printAllByCategory($pdo, 'caves', true);
            ?>
        </ul>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/Caves.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
