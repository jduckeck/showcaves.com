...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/MinesByCountry.html"/>
    <!-- begin responsive -->
    ...
    <title>Alphabethisches Register: Alle Schaubergwerke nach Ländern gruppiert</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">Alle Schaubergwerke nach Ländern gruppiert</h1>
        <h2 class="center"><?php print $count ?> Schaubergwerke werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/MinesByCountry.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
