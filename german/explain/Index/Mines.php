...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 align="center">All Mines</h1>
        <h2 align="center"><? print $count ?> Mines werden auf <span class="mySiteName">showcaves.com</span> am <? print date("d-M-Y H:i:s") ?> beschrieben</h2>
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?
            $sql = "SELECT name, filename, countrycode, country FROM sights WHERE visible='yes' AND category='mines' ORDER BY sortby";
            $filebase = "../../..";
            $Category = 'Mine';
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/Mines.php"><img alt="English" src="../../../graphics/flags/gb-small.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
