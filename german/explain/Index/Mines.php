...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/Mines.html"/>
    <!-- begin responsive -->
    ...
    <meta property="og:title" content="Alphabethisches Register: Alle Schaubergwerke"/>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?php
            printAllByCategory($pdo, 'mines', true);
            ?>
        </ul>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/Mines.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
