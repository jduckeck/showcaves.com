...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            ...
            <?
            $sql = "SELECT name, filename, countrycode, country FROM sights WHERE visible='yes' AND category='subterranea' ORDER BY sortby";
            $filebase = "../../..";
            $Category = 'Misc';
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/Subterranea.php"><img alt="English" src="../../../graphics/flags/gb-small.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
