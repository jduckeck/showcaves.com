...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/Showcaves.html"/>
    <!-- begin responsive -->
    ...
    <meta property="og:title" content="Alphabethisches Register: Alle Schauhöhlen"/>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">Alle Schauhöhlen</h1>
        <h2 class="center"><?php print $count ?> Schauhöhlen werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
        ...
        <ul id="theList" data-role="listview" data-inset="true" data-filter="true">
            <?php
            printAllByCategory($pdo, 'showcaves', true);
            ?>
        </ul>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" href="../../../english/explain/Index/Showcaves.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
