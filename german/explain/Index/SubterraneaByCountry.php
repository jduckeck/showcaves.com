...
<head>
    ...
    <link rel="alternate" hreflang="en" href="../../../english/explain/Index/SubterraneaByCountry.html"/>
    <!-- begin responsive -->
...
?>
    ...
    <meta property="og:title" content="Alphabethisches Register: Alle künstlichen Hohlräume nach Ländern gruppiert"/>
    ...
    <title>Alphabethisches Register: Alle künstlichen Hohlräume nach Ländern gruppiert</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <h1 class="center">Alle künstlichen Hohlräume nach Ländern gruppiert</h1>
        <h2 class="center"><?php print $count ?> künstliche Hohlräume werden auf <span class="mySiteName">showcaves.com</span> am <?php print strtoupper(date("d-M-Y H:i")) ?> beschrieben</h2>
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/SubterraneaByCountry.html"><img alt="English" src="../../../graphics/language/gb.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
