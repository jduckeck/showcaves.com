...
<head>
    ...
    $count = 0;
    $sql = "SELECT COUNT(*) AS count FROM sights WHERE visible='yes' AND category='subterranea'";
    ...
    <title>Alphabethisches Register: Alle künstlichen Hohlräume</title>
</head>
...
<div data-role="page" id="pageroot">
    <div data-role="main" class="ui-content">
        ...
        <?
        $sql = "SELECT name, filename, countrycode, country, chapter FROM sights WHERE visible='yes' AND category='subterranea' ORDER BY country, sortby";
        $Category = "Misc";
        $filebase = "../../..";
        $oldCountry = '';
        $entries = 0;
    ...
    <div data-role="header" data-position="fixed">
        <div data-role="navbar">
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="../../../english/explain/Index/SubterraneaByCountry.php"><img alt="English" src="../../../graphics/flags/gb-small.png" class="language"></a></li>
            </ul>
        </div>
    </div>
    <!-- Path End -->
    ...
    <div data-role="footer" data-position="fixed">
        <div data-role="navbar">
            ...
            <ul>
                ...
                <li><a data-ajax="false" target="_top" href="#" onClick="xemhid('askir','showcaves','com')">&Auml;nderungen und Kritik: <span class="mySiteName">showcaves.com</span>: <img class="xemhid" alt="contact" src="/xemhid.php?p1=askir&p2=showcaves&p3=com"></a></li>
            </ul>
        </div>
    </div>
    <!-- Navigation Bar End -->
