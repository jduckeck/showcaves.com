...
WHERE countrycode = 'dk';
INSERT INTO sights (visible, name, filename, sortby, continent, countrycode, country, category, region, Latitude, Longitude)
VALUES ('yes', 'Christiansborg Slot', '/english/dk/subterranea/Christiansborg.html', 'Christiansborg', 'Europe', 'dk', 'Denmark', 'subterranea', 'Hovedstaden', 55.676322, 12.580327);
INSERT INTO sights (visible, name, filename, sortby, continent, countrycode, country, category, region, Latitude, Longitude)
VALUES ('yes', 'Koldkrigsmuseet REGAN Vest', '/english/dk/subterranea/REGANVest.html', 'REGANVest', 'Europe', 'dk', 'Denmark', 'subterranea', 'Nordjylland', 56.823712, 9.801189);
INSERT INTO sights (visible, name, filename, sortby, continent, countrycode, country, category, region, Latitude, Longitude)
