...
UPDATE sights SET filename = REPLACE(filename, '/showcaves/', '/caves/'), category='caves', Latitude=31.779592, Longitude=130.961214 WHERE countrycode = 'jp' and sortby='Mizonoguch';
