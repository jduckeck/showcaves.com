...
UPDATE sights SET chapter=NULL,region=NULL,continent='Africa' WHERE countrycode = 'ke';
UPDATE sights SET filename = REPLACE(filename, '/other/', '/ke/') WHERE countrycode = 'ke';
