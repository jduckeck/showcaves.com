...
$Filename = $installDir."showcaves.com/surveys/Big/".$pic;
...
<table align="center" border="0" cellspacing="0" cellpadding="0" width="<? echo $size[0] ?>">
<tr><td><img src="<? echo $relRoot ?>image.php?pic=<? echo $pic ?>&type=s&size=big&key=<? echo time() ?>" alternate="<? echo $CaveName ?> - <? echo $Title ?>" width="<? echo $size[0] ?>" height="<? echo $size[1] ?>"></td></tr>
